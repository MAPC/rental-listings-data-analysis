...
all: listings_ARLINGTON_2020_11.shp\
	   listings_BOSTON_2020_11.shp\
	   listings_CAMBRIDGE_2020_11.shp\
	   listings_QUINCY_2020_11.shp\
	   listings_SOMERVILLE_2020_11.shp
...
clean:
	...
	rm data/finished/ARLINGTON/listings_ARLINGTON_2020_11-cleaned.csv
	rm data/finished/BOSTON/listings_BOSTON_2020_11-cleaned.csv
	rm data/finished/CAMBRIDGE/listings_CAMBRIDGE_2020_11-cleaned.csv
	rm data/finished/QUINCY/listings_QUINCY_2020_11-cleaned.csv
	rm data/finished/SOMERVILLE/listings_SOMERVILLE_2020_11-cleaned.csv

listings_ARLINGTON_2020_11-cleaned.csv: listings_ARLINGTON_unique_clean_full_units_2020-11.csv
...
listings_ARLINGTON_2020_11.shp: listings_ARLINGTON_2020_11-cleaned.csv
...
listings_BOSTON_2020_11-cleaned.csv: listings_BOSTON_unique_clean_full_units_2020-11.csv
...
listings_BOSTON_2020_11.shp: listings_BOSTON_2020_11-cleaned.csv
	mkdir -p data/finished/BOSTON/spatial
	ogr2ogr -s_srs EPSG:4326 -t_srs EPSG:4326\
		-oo X_POSSIBLE_NAMES=latitude -oo Y_POSSIBLE_NAMES=longitude -oo AUTODETECT_TYPE=YES\
		-f "ESRI Shapefile" data/finished/BOSTON/spatial/$(notdir $@) data/finished/BOSTON/$(notdir $<)

listings_CAMBRIDGE_2020_11-cleaned.csv: listings_CAMBRIDGE_unique_clean_full_units_2020-11.csv
...
listings_CAMBRIDGE_2020_11.shp: listings_CAMBRIDGE_2020_11-cleaned.csv
...
listings_QUINCY_2020_11-cleaned.csv: listings_QUINCY_unique_clean_full_units_2020-11.csv
...
listings_QUINCY_2020_11.shp: listings_QUINCY_2020_11-cleaned.csv
	mkdir -p data/finished/QUINCY/spatial
	ogr2ogr -s_srs EPSG:4326 -t_srs EPSG:4326\
		-oo X_POSSIBLE_NAMES=latitude -oo Y_POSSIBLE_NAMES=longitude -oo AUTODETECT_TYPE=YES\
		-f "ESRI Shapefile" data/finished/QUINCY/spatial/$(notdir $@) data/finished/QUINCY/$(notdir $<)

listings_SOMERVILLE_2020_11-cleaned.csv: listings_SOMERVILLE_unique_clean_full_units_2020-11.csv
...
listings_SOMERVILLE_2020_11.shp: listings_SOMERVILLE_2020_11-cleaned.csv
